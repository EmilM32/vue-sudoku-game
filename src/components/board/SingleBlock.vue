...
<template>
  <input
    ...
    class="w-10 h-10 md:w-14 md:h-14 appearance-none outline-none p-4 border text-center caret-transparent text-3xl dark:bg-slate-700 dark:border-slate-900 cursor-pointer"
  />
</template>
